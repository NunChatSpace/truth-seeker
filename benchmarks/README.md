...
Benchmark v3 compares an unchanged Codex baseline with the same Codex configuration plus the `focused` Truth Seeker lifecycle hook. It separates two claims:
...
- `claim-v3.md` locks the priority-boundary and mutation-detection controls before new paid runs; earlier claims remain historical.
